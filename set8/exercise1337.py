...
def string_list_please() -> list:
    ...
    return ["mustang","rolls royce","mercedes","porsche","toyota"]


def dictionary_please() -> dict:
    """Returns a dictionary, anything you like."""
    return {"name": "alex", "surname": "thompson"}
...
def greet(name="Towering Timmy") -> str:
    ...
    """
    first_part= "Well hello, "
    sentence= first_part + name
    return sentence
...
def set_it_on_fire(input_string="very naughty boy") -> str:
    ...
    """
    new_string='🔥'
    new_list=list(str(input_string).upper())
    answer= new_string + new_string.join(new_list) + new_string
    return answer
